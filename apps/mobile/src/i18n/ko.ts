...
export const ko = {
  ...
  records: {
    ...
    diagnose: '상태 진단',
    diagnoseFinding: (name: string) => `상태 진단, ${name}`,
  ...
  diagnose: {
    open: '상태 진단',
    title: (nickname: string) => `${nickname} 상태 보기`,
    guide: '아픈 곳이 잘 보이게 찍어 주세요. 잎 앞뒤와 줄기, 흙 쪽을 함께 찍으면 더 잘 봐요.',
    camera: '사진 찍기',
    library: '앨범에서 고르기',
    removePhoto: '사진 빼기',
    photo: (index: number) => `${index}번째 사진`,
    maxPhotos: '사진은 세 장까지 올릴 수 있어요',
    run: '진단하기',
    running: '사진을 보는 중이에요',
    runningWait: '30초쯤 걸려요',
    limit: '오늘은 진단을 세 번 모두 썼어요. 내일 다시 해 주세요.',
    failed: '지금은 진단할 수 없어요. 잠시 뒤에 다시 해 주세요.',
    photoFailed: '사진을 저장하지 못했어요. 다시 시도해 주세요.',
    cameraDenied: '카메라 권한이 꺼져 있어요. 설정에서 켜거나 앨범에서 골라 주세요.',
    cameraUnavailable: '이 기기에서는 카메라를 쓸 수 없어요. 앨범에서 골라 주세요.',
    daily: '하루에 세 번까지 진단할 수 있어요',
  },
  /** 진단 결과 (SPEC 8.1, 9.3) */
  diagnosis: {
    title: '진단 결과',
    missing: '진단 기록을 찾지 못했어요',
    urgent: '빨리 손써 주세요',
    findings: '의심되는 것',
    none: '뚜렷한 문제는 보이지 않아요',
    likely: { high: '가능성 높음', medium: '가능성 있음', low: '가능성 낮음' },
    cause: '이렇게 본 까닭',
    actions: '지금 할 일',
  ...
  settings: {
    ...
    /** 데이터 (SPEC 3.6). 기기 안에서만 만들고 서버로 보내지 않는다 */
    data: '데이터',
    exportTitle: '내보내기',
    exportRow: '파일로 내보내기',
    ...
    eraseRow: '전체 삭제',
    eraseTitle: '모두 지울까요',
    eraseBody: '식물과 기록, 사진을 모두 지워요. 되돌릴 수 없어요.',
    eraseConfirm: '모두 지우기',
    eraseDone: '모두 지웠어요',
    eraseFailed: '지우지 못했어요. 다시 시도해 주세요.',
  },
  /** 알림 시각 고르기 시트 */
  timeSheet: {
